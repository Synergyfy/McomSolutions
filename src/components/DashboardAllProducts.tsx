            ...
            >
              ...
              <div className="flex items-center gap-3 mt-auto">
                {platform.comingSoon ? (
                  ...
                  <>
                    <button className="flex-1 py-3 rounded-full bg-orange-500 hover:bg-orange-600 text-white font-bold text-sm transition-colors shadow-md shadow-orange-500/20 flex items-center justify-center gap-2">
