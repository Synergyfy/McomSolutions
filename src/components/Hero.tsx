  ...
  return (
    <section className="relative pt-32 pb-20 overflow-hidden bg-mesh">
      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white shadow-sm border border-gray-100 text-brand-blue text-sm font-bold mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-24">
            <Link to="/dashboard" className="w-full sm:w-auto bg-brand-blue text-white px-10 py-5 rounded-full font-bold text-xl hover:bg-blue-600 transition-all shadow-glow-lg flex items-center justify-center gap-2 group active:scale-95">
              Get Started Free
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Link>
            <button className="w-full sm:w-auto bg-white text-gray-900 px-10 py-5 rounded-full font-bold text-xl hover:bg-gray-50 transition-all border border-gray-200 flex items-center justify-center gap-2 active:scale-95">
