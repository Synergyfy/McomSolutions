                    ...
                    {currentBusinesses.map((b) => (
                        ...
                        <td className="px-8 py-6">
                            <div className="flex justify-center gap-3 opacity-0 group-hover:opacity-100 transition-opacity">
                             <button onClick={() => handleViewBusiness(b)} className="p-2.5 bg-gray-50 rounded-xl hover:bg-blue-50 hover:text-brand-blue transition-all shadow-sm">
                ...
                <div className="p-12 relative">
                    ...
                    {loadingDetails ? (
                        ...
                        <>
                            ...
                            <div className="bg-gray-50 rounded-2xl p-6 mb-8 grid grid-cols-2 gap-4 text-sm border border-gray-100">
                                <div>
