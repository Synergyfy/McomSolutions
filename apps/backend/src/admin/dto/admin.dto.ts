...
export class CreateBusinessUserDto {
  ...
  @ApiPropertyOptional({ example: 'Â£12k' })
  @IsOptional()
  @IsString()
  revenue?: string;
...
export class CreateLocalMallDto {
  ...
  // ── Extended LocalMall fields (full panel coverage) ──
  @ApiPropertyOptional({ example: 0 })
  @IsOptional()
  @IsNumber()
  businesses?: number;
  ...
  @ApiPropertyOptional({ example: 'https://example.com/mobile.png' })
  @IsOptional()
  @IsString()
  mobileBanner?: string;

  @ApiPropertyOptional({ example: 'con-1' })
  @IsOptional()
  @IsString()
...
export class UpdateLocalMallDto {
  ...
  // â”€â”€ Extended LocalMall fields (full panel coverage) â”€â”€
  @ApiPropertyOptional({ example: 0 })
  @IsOptional()
  @IsNumber()
  businesses?: number;
